...
const GatewayForm = ({
  ...
  const { fetchData: getGateways } = useFetch({
    url: `${process.env.API_URL}/gateways?type=washroom`,
    method: "GET",
  ...
  useEffect(() => {
    ...
    setIsNewFloor(false);
    setSelectedWashroom(initialValues.washroom ? initialValues.washroom : initialValues.room);
    ...
    <>
        ...
        <>
          ...
          <Form.Item label="Floor" name="gateway.floor._id" hasFeedback>
            ...
            >
              ...
              {!isSameInfra && selectedInfra?.floors?.map((floor, idx) => (
                <Select.Option key={idx} value={floor._id}>
                  {floor.sign}
                </Select.Option>
              ))}
            </Select>
      ...
      {selectedFloor || isNewFloor ? (
        <>
          ...
          <Form.Item
            label="Room"
            name={selectedWashroom?.label ? "gateway.room._id" : "gateway.washroom._id"}
            hasFeedback
          ...
          >
            ...
            >
              ...
              {!isSameFloor && values.washroom?._id === "ADDNEW" && (
                <Select.Option value="SAME_WITH_SENSOR">
