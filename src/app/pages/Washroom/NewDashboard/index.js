...
const Dashboard = (props) => {
  ...
  const { loading, fetchData: getSensors } = useFetch({
    url: `${process.env.API_URL}/sensors?applicationType=washroom`,
    method: "GET",
    onSuccess: (data) => {
      setSensors(data);
      if (data.length < 1) {
    ...
    <div className="p-4" style={{ marginBottom: 150 }}>
      ...
      <div className="row">
        <div className="plotly_button_main_div">
          ...
          <div className="plotly_butotn_container">
            <Button
              type="default"
              className="col mb-3"
              block
            ...
            <div className="media">
              ...
              <div className="media-body">
                ...
                {sensorData?.createdAt
                  ? moment(sensorData?.createdAt).format("DD/MM/YYYY HH:mm:ss")
                  : "--/--/---- --:--:--"}
